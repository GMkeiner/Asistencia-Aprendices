...
//         const dia = cells[1].innerText;
//         const hora = cells[2].innerText;
//         const checkboxes = cells[3].getElementsByTagName('input');
//         const comentario = cells[6].getElementsByTagName('input')[0].value;
...
//             if (checkbox.checked) {
//                 selectedStatus = checkbox.getAttribute('data-status');
//                 break;
//             }
//         }
...
//             dia,
//             hora,
//             asistio: selectedStatus,
//             noAsistio: selectedStatus2,
//             excusa: selectedStatus3,
//             comentario
//         });
//     }
